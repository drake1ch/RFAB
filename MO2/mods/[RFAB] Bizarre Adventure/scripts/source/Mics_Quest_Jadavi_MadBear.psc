...
Scriptname Mics_Quest_Jadavi_MadBear Extends Quest Hidden
...
;BEGIN ALIAS PROPERTY JadaviChest
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_JadaviChest Auto
;END ALIAS PROPERTY
...
Alias_JadaviChest.GetRef().Reset()
Stop()
;END CODE
EndFunction
;END FRAGMENT
