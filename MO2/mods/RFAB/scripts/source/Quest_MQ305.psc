...
Scriptname Quest_MQ305 Extends Quest Hidden
...
;(BAQuest as RFAB_BA_Quest_Alduin).TeachDragonrend()
;(BAQuest as RFAB_BA_Quest_Alduin).TeachClearSkies()
;END CODE
EndFunction
;END FRAGMENT
