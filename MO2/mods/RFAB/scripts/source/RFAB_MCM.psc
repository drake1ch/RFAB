...
Function ShowAutoLoot()
	...
	AddToggleOptionST("AutoLoot_LootTrophies", "Всегда поднимать трофеи", AutoLoot.LootTrophies)
...
State AutoLoot_LootMisc
	...
	EndEvent
	Event OnHighlightST()
		SetInfoText("Всегда подбирать шкуры животных и ингредиенты, даже если они не соответствуют параметрам подбора.")
	EndEvent
EndState

State AutoLoot_LootTrophies
	Event OnSelectST()
		AutoLoot.LootTrophies = !AutoLoot.LootTrophies
		SetToggleOptionValueST(AutoLoot.LootTrophies)
	EndEvent
	Event OnHighlightST()
		SetInfoText("Всегда подбирать трофеи, такие как головы бандитов.")
	EndEvent
EndState
