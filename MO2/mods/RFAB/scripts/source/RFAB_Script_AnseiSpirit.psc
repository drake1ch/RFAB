Scriptname RFAB_Script_AnseiSpirit extends ActiveMagicEffect
...
Event OnAnimationEvent(ObjectReference akSource, string asEventName)
    ...
    if asEventName == "AttackPowerStanding_FXStart" || asEventName == "AttackPowerForward_FXStart" && Caster.IsSprinting() || asEventName == "AttackPowerRight_FXStart" || asEventName == "AttackPowerLeft_FXStart" || asEventName == "AttackPowerBackward_FXStart"
        UpdateWaveDamage()
        CastWave()
    elseIf asEventName == "WeaponSwing" && PowerAttack
        UpdateWaveDamage()
        CastWave()
    elseIf asEventName == "WeaponLeftSwing" && PowerAttack
        UpdateWaveDamage()
        CastWave()
    endif
EndEvent
...
Event OnWeaponHit(ObjectReference akTarget, Form akSource, Projectile akProjectile, Int aiHitFlagMask)
	Int WeaponType = (akSource as Weapon).GetWeaponType()
	if  (WeaponType < 7) && (akTarget as Actor)
        UpdateDamage()
