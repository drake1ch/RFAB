...
Game.GetPlayer().Moveto(RFAB_StartMarker)
utility.wait(0.3)
...
Alias_ImperialSoldier01.GetReference().DisableNoWait()
Alias_ImperialSoldier02.GetReference().DisableNoWait()
Alias_ImperialSoldierHelgen01.GetReference().DisableNoWait()
Alias_ImperialSoldierHelgen02.GetReference().DisableNoWait()
;END CODE
EndFunction
;END FRAGMENT
...
ObjectReference Property RFAB_StartMarker  Auto  

Cell Property RFAB_StartCell  Auto  
