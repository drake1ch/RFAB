...
; RFAB
FormList Property WerewolfPerks auto
Spell Property Totem01 auto
Spell Property Totem02 auto
Spell Property Totem03 auto
...
; 	Debug.Trace("WEREWOLF: Curing the player of lycanthropy.")
	...
	;kPlayer.RemoveSpell(BeastForm)
	kPlayer.RemoveSpell(WerewolfImmunity)

	; FIX FOR 81462
	kPlayer.RemoveSpell(HircinesRingPower)
	; END FIX FOR 81462

	; RFAB
	int i = WerewolfPerks.GetSize()
	while (i > 0)
		i -= 1
		kPlayer.RemovePerk(WerewolfPerks.GetAt(i) as Perk)
	endwhile

	kPlayer.RemoveSpell(Totem01)
	kPlayer.RemoveSpell(Totem02)
	kPlayer.RemoveSpell(Totem03)
	;
	...
	kPlayer.SendLycanthropyStateChanged(false)
EndFunction
